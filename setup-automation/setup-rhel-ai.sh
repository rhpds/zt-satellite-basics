...
Exec=--foreman-url https://satellite.lab --allowed-rex-features "katello_upload_profile,katello_module_stream_action,katello_bootc_action,katello_bootc_upgrade,katello_bootc_switch,katello_bootc_rollback,katello_bootc_status,puppet_run_host,run_script,ansible_run_host,ansible_run_playbook,ansible_enable_web_console,ansible_run_capsule_upgrade,ansible_run_capsule_update,leapp_preupgrade,leapp_upgrade,leapp_remediation_plan,foreman_openscap_run_scans,ansible_run_openscap_remediation,script_run_openscap_remediation,rh_cloud_remediate_hosts,rh_cloud_connector_run_playbook,ansible_configure_cloud_connector,katello_package_install,katello_package_install_by_search,katello_package_update,katello_packages_update_by_search,katello_package_remove,katello_packages_remove_by_search,katello_group_install,katello_group_update,katello_group_remove,katello_errata_install,katello_errata_install_by_search,katello_service_restart,katello_host_tracer_resolve,katello_change_content_source" --allowed-cv-actions "publish,promote,incremental_update"
