...
https://access.redhat.com/documentation/en-us/red_hat_satellite/6.18/html/managing_hosts/configuring_host_collections_managing-hosts[Configuring
Host Collections].
...
You’ll be taken to the job status page. You can check on the real-time installation progress by clicking on a host.
