...
https://docs.redhat.com/en/documentation/red_hat_satellite/6.19/html/overview_concepts_and_deployment_considerations/common-deployment-scenarios#host-group-structures[documentation].
