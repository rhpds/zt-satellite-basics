...
https://docs.redhat.com/en/documentation/red_hat_satellite/6.18/html/overview_concepts_and_deployment_considerations/common-deployment-scenarios#host-group-structures[documentation].
...
.Host group details
image::createhostgroup-new-1.png[create host group]
...
=====
.Configure the parameters for the Ansible role
[%collapsible]
====
