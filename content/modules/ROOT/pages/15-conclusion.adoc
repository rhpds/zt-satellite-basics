...
* https://docs.redhat.com/en/documentation/red_hat_satellite/6.18/html/managing_hosts/converting-hosts-to-rhel[Use
...
Satellite Product lifecycle]

If you have any feedback, please let us know.

* https://github.com/rhpds/zt-satellite-basics/issues[File a GitHub issue]
