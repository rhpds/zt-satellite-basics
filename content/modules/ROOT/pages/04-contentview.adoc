...
https://access.redhat.com/documentation/en-us/red_hat_satellite/6.19/html/managing_content/managing_content_views_content-management[Managing
...
.Review the details
image::publish-review.png[../assets/publish-review]

It will take anywhere from a few seconds to a few minutes to publish the content view, depending on the number of changes made.

image::publishing-content-view.png[../assets/publishing-content-view]
