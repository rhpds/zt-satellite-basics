...
change of assigned lifecycle environment, and change of Content View.
...
https://access.redhat.com/documentation/en-us/red_hat_satellite/6.19/html/managing_hosts/configuring_host_collections_managing-hosts[Configuring
Host Collections].
...
Now you'll install software using the host collection.
...
You’ll be taken to the job status page. You can check on the real-time installation progress by clicking on the > or chevron next to the host name.

.Chevron
image::chevron_host.png[../assets/chevron_host]

See the job details below.
