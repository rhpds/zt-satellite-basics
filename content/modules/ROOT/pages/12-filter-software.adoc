...
. Give the filter a description. We’re going to prevent emacs from being
included in the `+RHEL10+` content view.

[source,json]
----
prevent emacs from being installed
----
...
Click `+Publish new version+` to publish a new version of the `+RHEL10+`
...
Now all your users will be forced to use a good text editor like vim.
