...
== Introduction to Red Hat Satellite 6.18 Basics

The lab environment consists of the following

- Red Hat Satellite 6.18.0 Server (Satellite is preinstalled and content/software is synchronized.)
